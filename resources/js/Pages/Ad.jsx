...
import { Card, Typography, Button, Chip, Avatar, Box, Grid, Alert } from "@mui/material";
    ...
    return (
        <NavigationLayout user={auth.user}>
            ...
            <Box sx={{
                ...
                <Grid container spacing={2} rowSpacing={2} sx={{ display: 'flex', alignItems: 'stretch' }}>
                    <Grid item xs={12} md={4} sx={{ width: "100%", height: { md: "395px" }, }}>
                        <Card
                            sx={{
                                display: 'flex',
